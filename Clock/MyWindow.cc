...
/*
 * 1. Дорисовать циферблат, сделав минутные/секундные штрихи +
 * 1.5 Нарисовать цифры (опционально) по желанию
 * 2. Добавить минутную и часовую стрелки +
 *
 *3. Дорисовать часы. Часы должны предтавлять собой
 *   параллелепипед. Боковые грани должны иметь свои
 *   цвета.
 *
 *   4. Вся сцена должна медленно вращаться.
 */
